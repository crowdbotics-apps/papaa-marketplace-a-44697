...
## Project Structure
    ...
    ├── papaa_marketplace_a_44697  # Django project configurations
...
1. Clone this repo and `cd papaa_marketplace_a_44697`
...
2. Clone this repo and `cd papaa_marketplace_a_44697`
